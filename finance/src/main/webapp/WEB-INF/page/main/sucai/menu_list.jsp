		  ...
		  var param = {
    		  ...
    		  $.post('${ctx}/sucai/eshow.do',param,function (data) {
      			...
      			for(var i=0;i<l.length;i++){
          			...
          			html+='        			 <button type="button" title="重命名" class="layui-btn layui-btn-primary " onclick="editInput(this,\''+l[i].name+'\',\''+l[i].id+'\')">';
       ...
       <!-- 按钮操作 -->
        <div class="table_control">
            ...
            <div class="table_search" style="width: 480px;float: right; font-size: 3;color: red;height:50px; line-height:50px;right:50px;" >
            	*注意：所有的上传文件的文件名称中不要带有特殊字符或标点符号
            </div>
            <!-- 搜索区域操作 -->
            <!-- <div class="table_search" style="width: 480px;float: right;">
                 <input type="text" id="search" class="keyword" placeholder="请在这里输入关键字" style="height:25px;"> 
