		...
		<form id="form" class="layui-form layui-form-pane" action="">
            	...
            	<div id="opt1">
          		...
          		<div class="layui-form-item">
		              	...
		              	<div class="layui-input-block">
                   			<input type="text" id="orderPlace" name="orderPlaceId" required="" lay-verify="required" placeholder="--请选择--" readonly="" autocomplete="off" class="layui-input" value="${pojo.orderPlaceId}" disabled="disabled"> 
               ...
               <div class="layui-input-block" style="text-align: center;">
                   ...
                   <button class="layui-btn" type="button" onclick="uploadExcel()" id="btg">不通过</button>
