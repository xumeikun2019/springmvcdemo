...
public interface CDeviceMapper {
	...
	@Select("select id , ip , type from c_device")
	List<Map<String, Object>> findAll();

	Map<String, Object> findByRemoteAddr(String remoteAddr);

	@Select("select a.deviceIds , a.dates ,a.times ,b.jg ,b.sucaiIds from c_jihua a join c_jiemu b on a.jiemuId = b.id and a.ispass = '3' and a.pubdate is not null")
	List<Map<String, Object>> findJihuaJiemu();

	List<Map<String, Object>> allList(Map<String, Object> map);

	List<Map<String, Object>> findDeviceByMap(Map<String, Object> map);
