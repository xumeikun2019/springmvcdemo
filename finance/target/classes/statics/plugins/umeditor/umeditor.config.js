...
(function () {
     ...
     * "相对于网站根目录的相对路�?"也就是以斜杠�?头的形如"/myProject/umeditor/"这样的路径�??
    ...
    base_path = base_path.replace("statics/",""); 
    ...
    window.UMEDITOR_CONFIG = {
        ...
        //图片上传配置�?
        ,imageUrl:base_path + "upload/image.do"             //图片上传提交地址
        ,imagePath:URL + "../../../upload/"                 //图片修正地址，引用了fixedImagePath,如有特殊�?求，可自行配�?
        ,imageFieldName:"upfile"                   //图片数据的key,若此处修改，�?要在后台对应文件修改对应参数
        ...
        //,initialContent:'欢迎使用UMEDITOR!'    //初始化编辑器的内�?,也可以�?�过textarea/script给�?�，看官网例�?
        ...
        //注意这里添加的样式，�?好放�?.edui-editor-body .edui-body-container这两个的下边，防止跟页面上css冲突
