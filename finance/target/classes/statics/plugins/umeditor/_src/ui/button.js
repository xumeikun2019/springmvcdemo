//button ç±?
UM.ui.define('button', {
    tpl: '<<%if : !${texttype}%>div class="edui-btn edui-btn-${icon} <%if : finance Maven Webapp%>edui-btn-name-finance Maven Webapp<%/if%>" unselectable="on" onmousedown="return false" <%else%>a class="edui-text-btn"<%/if%><% if: ${title} %> data-original-title="${title}" <%/if%>> ' +
