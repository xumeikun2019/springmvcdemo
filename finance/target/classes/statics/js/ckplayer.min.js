...
function ckplayerConfig() {
	return {
		...
		config: {
			...
			timeScheduleAdjust: 1,//是否可调节调节栏,0不启用，1是启用，2是只能前进（向右拖动），3是只能后�?�?4是只能前进但能回到第�?次拖动时的位置，5是看过的地方可以随意拖动
