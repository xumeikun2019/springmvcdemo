        ...
        {data: function (obj) {
        	if("${user.dept}"=="0"){
        		...
        		if(obj.meeting_step=="2"){
                    return "<a class='layui-btn layui-btn-sm _aa' name='change_btn' onclick='qx(\""+obj.id+"\")' >取消预约</a>";		//获取�?:data["brand_id"]
...
//                    return "<a class='layui-btn layui-btn-sm _aa' name='change_btn' onclick='newTab(\"审批\",\"\",\"${ctx}/main/meetingOrder/edit.shtml?id="+obj.id+"\")' >审批</a>";		//获取�?:data["brand_id"]
        		}
        	}      	
        }}
    ];
