	...
	<div class="layui-tab">
		...
		<div class="layui-tab-content">
				...
				<div class="admin-main">
				   ...
				   <!--表格区域  -->
				    <div style="float: right;width: 100%;height: 100%">
				   	...
				   	<form id="exportForm" action="${ctx}/main/meetingOrder/export.do" method="post">
				   		<input type="hidden" name="pageSize" value="999999999">
				   		<input type="hidden" id="name" name="name" value="">
				   		<input type="hidden" name="fileName" value="公司领导本周会议">
	   				</form>
				</div>
		    ...
		    <div class="layui-tab-item">
		    	<!-- 
		    	<div class="admin-main">
					 <div class="admin-main"  style="width: 10%;float: left;">
				           <div class="layui-card">
				               <div class="layui-card-header">领导姓名</div>
				               <div class="layui-card-body" id="ld2">
				               					                   				                   
				               </div>
				           </div>
				     </div>
				    <div style="float: right;width: 78%;height: 560px">
				    	<table style="width: 100%;height: 93%" align="center" border="1px;"  cellspacing="0" cellpadding="0" id="wdhy1">
				            ...
				            <div class="table_search">             
					           <div class="layui-form">				
					             <div class="layui-inline">
					                    ...
					                    <!-- 
					                    <div class="layui-input-inline">
					                       	<input type="text" id="ld1" required="" lay-verify="required" placeholder="--请�?�择--" readonly="" autocomplete="off" class="layui-input"> 
...
$(function(){
	...
	/*
	$.post('${ctx}/main/meetingOrder/findld.do',{},function (json) {
		console.log(json);
		var ld="";
		var ld2="";
		for(var i=0;i<json.data.length;i++){
			ld+="<li onclick='search(\""+json.data[i].value+"\")'>"+json.data[i].title+"</li>";
			ld2+="<li onclick='search2(\""+json.data[i].value+"\")'>"+json.data[i].title+"</li>";
		}
		$("#ld1").html(ld);
		$("#ld2").html(ld2);
	})*/
...
/*
function search(id){
	 $.post('${ctx}/main/meetingOrder/meetingListld.do?userid='+id,{},function (json) {
		 console.log(json);
		   var wdhy="<tr style='height: 16%' align='center'>"+
			"<td style='width: 14%'>星期�?</td>"+
			"<td style='width: 14%'>星期�?</td>"+
			"<td style='width: 14%'>星期�?</td>"+
			"<td style='width: 14%'>星期�?</td>"+
			"<td style='width: 14%'>星期�?</td>"+
			...
			for(var i=0;i<6;i++){
				var Monday="";var Wednesday="";var Wednesday="";var Thursday="";var Friday="";var Saturday="";var Sunday="";
				if(xq1[i]!=undefined){
					Monday=xq1[i];
				}
				if(xq2[i]!=undefined){
				...
				wdhy+="<tr style='height: 14%' align='center'>"+
					"<td style='font-size:16px' >"+Monday+"</td>"+
					"<td style='font-size:16px' >"+Tuesday+"</td>"+
					"<td style='font-size:16px' >"+Wednesday+"</td>"+
					"<td style='font-size:16px' >"+Thursday+"</td>"+
					"<td style='font-size:16px' >"+Friday+"</td>"+
					"<td style='font-size:16px' >"+Saturday+"</td>"+
					"<td style='font-size:16px' >"+Sunday+"</td>"+
					"</tr>";
			}
...
function search2(id){
	 $.post('${ctx}/main/meetingOrder/meetingListldxz.do?userid='+id,{},function (json) {
		   var wdhy="<tr style='height: 16%' align='center'>"+
			"<td style='width: 14%'>星期�?</td>"+
			"<td style='width: 14%'>星期�?</td>"+
			"<td style='width: 14%'>星期�?</td>"+
