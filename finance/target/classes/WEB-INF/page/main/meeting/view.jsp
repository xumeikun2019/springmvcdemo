		...
		<form id="form" class="layui-form layui-form-pane" action="">
            	...
            	<div id="opt1">
          		...
          		<div class="layui-form-item">
		              	...
		              	<div class="layui-input-block">
                   			<input type="text" id="orderPlace" name="orderPlace" required="" lay-verify="required" placeholder="--请�?�择--" readonly="" autocomplete="off" class="layui-input" value="${pojo.orderPlaceId}" disabled="disabled"> 
            	...
            	<div id="opt2">
          		...
          		<div class="layui-form-item">
		               	<label class="layui-form-label">审核状�??</label>
		              	<div class="layui-input-block">
          		...
          		<c:if test="${pojo.state != null}">
          			<div class="layui-form-item">
		               	<label class="layui-form-label">审核原因</label>
		              	<div class="layui-input-block">
                   			<textarea class="layui-textarea" name="remark" id="remark" disabled="disabled">${pojo.state}</textarea>
               			</div>
          		</div> 
          		</c:if>    		
                 <div class="layui-form-item">
