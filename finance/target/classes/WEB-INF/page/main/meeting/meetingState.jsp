					   ...
					   if(placeId == parentId){
						   if(flag !== undefined){
							   if(flag=='1'){
								    ...
								    html += '<div class="rooms"> <div class="room-container"> <div class="meeting-room"> <label>�?</label> </div> <div class="room-name"> <label>'+ placeName +'</label> </div> </div> </div>';   
								    }
						   }
...
<blockquote class="layui-elem-quote" style="margin-bottom: 30px;">会议室状态说�?  &nbsp;&nbsp;  当前时间有会议：显示会议名称 &nbsp;&nbsp;&nbsp;&nbsp;当前时间无会议：显示会议室名�?</blockquote>
