...
$(function(){
    ...
    var url = '${ctx}/main/attendanceRecord/companylist.do';
    var columns = [ //定义�?
        {"data": function (obj) {
        ...
        {data: "zzrs"},
        {data: function (obj) {
        	return obj.zzrs-obj.cddkts;     	
        }},
        {data: "cddkts"},
        {data: "ztdkts"},
        {data: function (obj) {
        	return '<a class="layui-btn layui-btn-sm _aa" name="change_btn" href="${ctx}/main/attendance/departmentAtt.shtml?id='+obj.id+'&data='+$("#time").val()+' " >查看</a>';     	
        }}
    ];
