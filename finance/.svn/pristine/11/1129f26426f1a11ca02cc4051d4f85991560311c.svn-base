...
<body>
   <div class="container">
       ...
       <form class="layui-form layui-form-pane" action="">
           ...
           <div class="layui-form-item">
               <label class="layui-form-label">所在楼层<span style="color: red">*</span></label>
           ...
           <div class="layui-form-item">
               ...
               <div class="layui-input-block">
                   <input type="text" name="kh" lay-verify="required" maxlength="20" autocomplete="off" placeholder="请输入卡号" class="layui-input"  value="${pojo.kh}">
               </div>
           </div>
           <div class="layui-form-item">
