...
public interface SysDepartmentMapper {
	 ...
	 * @return
	 */
	@Insert("insert into c_visitor_user (id, visitor_id, user_card, user_name,img,lxdh ) values(#{uuidv},  #{uuid},  #{idcard}, #{vname},#{imgUrl},#{phone})")
	int saveVisitorUser(@Param("uuidv")String uuidv, @Param("uuid")String uuid, @Param("idcard")String idcard, @Param("vname")String vname, @Param("imgUrl")String imgUrl, @Param("phone")String phone);
