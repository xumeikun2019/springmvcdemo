...
public class SysDepartmentController extends GridController {
     ...
     */
    @ResponseBody
	@RequestMapping("/ldTree")
	public JSONArray ldTree(@RequestParam Map<String, Object> map) {    	
    	JSONArray result = null;
		try {
			result = sysDepartmentService.findldTreeListToJSON(map);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return result;
     ...
     */
    @ResponseBody
	@RequestMapping("/ptygTree")
	public JSONArray ptygTree(@RequestParam Map<String, Object> map) {    	
    	JSONArray result = null;
		try {
			result = sysDepartmentService.findptygTreeListToJSON(map);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return result;
