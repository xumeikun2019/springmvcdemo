...
//    console.log(signList);
  ...
  drawCal : function(iYear, iMonth ,signList,signLists) {
   ...
   htmls.push("</div>");
   htmls.push("<div>");
   htmls.push("<div style='display:flex;justify-content:space-around;margin-bottom:5px';><div style='font-size: 0.3vw;'>星期日</div><div style='font-size: 0.3vw;'>星期一</div><div style='font-size: 0.3vw;'>星期二</div><div style='font-size: 0.3vw;'>星期三</div><div style='font-size: 0.3vw;'>星期四</div><div style='font-size: 0.3vw;'>星期五</div><div style='font-size: 0.3vw;'>星期六</div></div>");
   htmls.push("</div>");
