...
<div class="container">
		<fieldset class="layui-elem-field layui-field-title"
			...
			<legend>会议室预约审�?</legend>
		</fieldset>
		<form id="form" class="layui-form layui-form-pane" action="">
                <div class="layui-form-item">
		               <label class="layui-form-label">预约部门</label>
		               <div class="layui-input-block">
 							<input type="text" id="department" required="" lay-verify="required" placeholder="--请�?�择--" readonly="" autocomplete="off" class="layui-input" value="${pojo.orderDeptId}" disabled="disabled"> 
            	...
            	<div id="opt1">
          		...
          		<div class="layui-form-item">
		              	...
		              	<div class="layui-input-block">
		  					<!-- <a class="layui-btn" id="btn">上传会议资料</a> �?�?200m�? -->
          		...
          		<div class="layui-form-item">
		              	...
		              	<div class="layui-input-block">
                   			<input type="text" id="orderPlace" name="orderPlaceId" required="" lay-verify="required" placeholder="--请�?�择--" readonly="" autocomplete="off" class="layui-input" value="${pojo.orderPlaceId}" disabled="disabled"> 
                      		<input name='orderPlace' id="orderPlaceId"  type="hidden"   class="layui-input">     
               			</div>
          		</div>
            	...
            	<div id="opt3">
          		...
          		<div class="layui-form-item">
		              	...
		              	<div class="layui-input-block">
                   			<input type="text" id="ld" required="" lay-verify="required" placeholder="--请�?�择--" readonly="" autocomplete="off" class="layui-input" value="${pojo.orderLduserId}" disabled="disabled"> 
          		...
          		<div class="layui-form-item">
		              	...
		              	<div class="layui-input-block">
                   			<input type="text" id="participants" name="userId" required="" lay-verify="required" placeholder="--请�?�择--" readonly="" autocomplete="off" class="layui-input" value="${pojo.userId}" disabled="disabled"> 
               ...
               <div class="layui-input-block" style="text-align: center;">
               		...
               		<input type="hidden" id="meetingStep" name="meetingStep"  value="${pojo.meetingStep}">
                    <button class="layui-btn save-btn" lay-submit="" lay-filter="demo1" id="tg">通过</button>
                   <button class="layui-btn" type="button" onclick="uploadExcel()" id="btg">不�?�过</button>
...
layui.use(['form', 'layedit','eleTree','laydate','upload'], function(){
	 ...
	 laydate.render({
      ...
      form.on('submit(demo1)', function(data){
          ...
          var url = '${ctx}/main/meetingOrder/sptg.do';
