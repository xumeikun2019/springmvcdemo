                   ...
                   <div class="layui-card-body">
                       ...
                       <div class="container">
		                   ...
		                   <div class="layui-form-item">
		                       ...
		                       <div class="layui-input-block">
		                           <input type="text" id="menuName" name="menuName" lay-verify="required" autocomplete="off" placeholder="请输入菜单名�?" class="layui-input">
		                       </div>
		                   </div>
		                   ...
		                   <div class="layui-form-item">
		                       ...
		                       <div class="layui-input-block">
		                           <input type="text" id="dataUrl" name="dataUrl"  autocomplete="off" placeholder="请输入菜单地�?" class="layui-input">
		                       </div>
		                   </div>
		                       ...
		                       <div class="layui-input-block">
		                           <input type="text" id="iconA" name="icon"  autocomplete="off" placeholder="请输入菜单地�?" class="layui-input">
		                       </div>
		                   </div>
		                   ...
		                   <div class="layui-form-item">
		                       ...
		                       <div class="layui-input-block">
		                           <input type="number" id="sort" name="sort" lay-verify="required" autocomplete="off" placeholder="请输入排序编�?" class="layui-input" value="${pojo.roleName}">
		                       </div>
		                   </div>
           ...
           <div id="form-container">
               <form class="layui-form layui-form-pane" style="margin: 10px;">
                   ...
                   <div class="layui-form-item">
                       <label class="layui-form-label">菜单名称<span style="color: red">*</span></label>
                       <div class="layui-input-block">
                           <input type="text" name="menuName" lay-verify="required" autocomplete="off" placeholder="请输入菜单名�?" class="layui-input">
                       </div>
                   </div>
                   ...
                   <div class="layui-form-item">
                       <label class="layui-form-label">菜单地址</label>
                       <div class="layui-input-block">
                           <input type="text" name="dataUrl" autocomplete="off" placeholder="请输入菜单地�?" class="layui-input">
                       </div>
                   </div>
