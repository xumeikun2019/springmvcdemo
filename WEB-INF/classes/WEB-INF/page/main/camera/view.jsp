	...
	<div class="layui-tab">
		...
		<div class="layui-tab-content">
			...
			<div class="layui-tab-item">				
				<table >
					<tr id="firstTr">
						<td><input type="datetime-local" id="beginTime"/>�?<input type="datetime-local" id="endTime"/><button onclick="huifang()">回放</button></td>
						<td><button style="color:red;font-weight:bold;display:none" id="err">请填全年月日时分，前后相�?3日之内！</button></td>
