/*
	...
	--------------------------------------------------------------------------------------------------------------------
	�?发说明：
	使用的主要程序语�?：javascript(js)及actionscript3.0(as3.0)(as3.0主要用于flashplayer部分的开发，不在该页面呈�?)
	功能：播放视�?
...
function ckplayerConfig() {
	return {
		...
		stylePath: '',//风格包文件地�?
		config: {
			fullInteractive: false,//是否�?启交互功�?
			delay: 30,//延迟加载视频，单位：毫秒
			timeFrequency: 100,//计算当前播放时间和加载量的时间频率，单位：毫�?
			autoLoad: true,//视频是否自动加载
			loadNext: 0,//多段视频预加载的段数，设置成0则全部加�?
			definition: true,//是否使用清晰度组�?
			subtitle:false,//是否使用多字幕切换组�?
			playbackRate:true,//是否使用倍�?�播放组�?
			smartRemove: true,//是否使用智能清理，使用该功能则在多段时当前播放段之前的段都会被清除出内存，减少对内存的使�?
			bufferTime: 200,//缓存区的长度，单位：毫秒,不要小于10
			rtmpBufferTime:0,//rtmp视频缓存区长度，单位：毫�?
			click: true,//是否支持屏幕单击暂停
			doubleClick: true,//是否支持屏幕双击全屏
			doubleClickInterval: 200,//判断双击的标准，即二次单击间隔的时间差之内判断为是双击，单位：毫�?
			keyDown: {
				space: true,//是否启用空格键切换播�?/暂停
				left: true,//是否启用左方向键快�??
				right: false,//是否启用右方向键快进
				up: true,//是否支持上方向键增加音量
				down: true //是否支持下方向键减少音量
			},
			timeJump: 10,//快进快�??时的秒数
			volumeJump: 0.1,//音量调整的数量，大于0小于1的小�?
			timeScheduleAdjust: 3,//是否可调节调节栏,0不启用，1是启用，2是只能前进（向右拖动），3是只能后�?�?4是只能前进但能回到第�?次拖动时的位置，5是看过的地方可以随意拖动
			previewDefaultLoad: true,//预览图片是否默认加载，优点是鼠标第一次经过进度条即可显示预览图片
			promptSpotTime: false,//提示点文字是否在前面加上对应时间
			buttonMode: {
				player: false,//鼠标在播放器上是否显示可点击形�??
				controlBar: false,//鼠标在控制栏上是否显示可点击形�??
				timeSchedule: true,//鼠标在时间进度条上是否显示可点击形�??
				volumeSchedule: true //鼠标在音量调节栏上是否显示可点击形�??
			},
			liveAndVod: { //直播+点播=回播功能
				open: false,//是否�?启，�?启该功能�?要设置flashvars里live=true
				vodTime: 2,//可以回看的整点数
				start: 'start' //回看请求参数
			},
			usehardwareeecoder:false,//是否采用硬件加�?�，只针对flashplayer有效
			errorNum: 3,//错误重连次数
			playCorrect: false,//是否�?要错误修正，这是针对rtmp�?
			timeCorrect: true,//http视频播放时间错误纠正，有些因为视频格式的问题导致视频没有实际播放结束视频文件就返回了stop命令
			m3u8Definition: { //m3u8自动清晰度时按关键字来进行判�?
				//tags:['200k','110k','400k','600k','1000k']
			},
			m3u8MaxBufferLength: 30,//m3u8每次缓冲时间，单位：秒数
			split: '|',//当视频地�?采用字符形式并且�?要使用�?�号或其它符号来切割数组里定�?
			timeStamp: '',//�?个地�?，用来请求当前时间戳，用于播放器内部时间效准
		...
		style: { //风格部分内容配置，这里主要配置loading和logo以及广告的部分内�?
			loading: { //视频加载前显示在播放器中间的图片，如果不�?要可以删除该属�??
			...
			logo: { //显示在右上角的logo图片，如果不�?要可以删除该属�??
				file: '',
				align: 'right',
				vAlign: 'top',
				offsetX: -100,
			...
			advertisement: { //广告相关的配�?
				time: 5,//广告默认播放时长以及多个广告时每个广告默认播放时间，单位：秒
				method: 'get',//广告监测地址默认请求方式，get/post
				videoForce: false,//视频广告是否强制播放结束
				videoVolume: 0.8,//视频音量
				skipButtonShow: true,//是否显示跳过广告按钮
				linkButtonShow: true,//是否显示广告链接按钮，如果�?�择显示，只有在提供了广告链接地�?时才会显�?
				muteButtonShow: true,//是否在视频广告时显示静音按钮
				closeButtonShow: true,//暂停时是否显示关闭广告按�?
				closeOtherButtonShow: true,//其它广告是否�?要关闭广告按�?
				frontSkipButtonDelay: 1,//前置广告跳过广告按钮延时显示的时间，单位：秒
				insertSkipButtonDelay: 0,//插入广告跳过广告按钮延时显示的时间，单位：秒
				endSkipButtonDelay: 0,//后置广告跳过广告按钮延时显示的时间，单位：秒
				frontStretched: 2,//前置广告拉伸方式�?0=原始大小�?1=自动缩放�?2=只有当广告的宽或高大于播放器宽高时才进行缩放�?3=参�?�播放器宽高�?4=宽度参�?�播放器宽�?�高度自动，5=高度参�?�播放器高�?�宽度自�?
				insertStretched: 2,//插入广告拉伸方式�?0=原始大小�?1=自动缩放�?2=只有当广告的宽或高大于播放器宽高时才进行缩放�?3=参�?�播放器宽高�?4=宽度参�?�播放器宽�?�高度自动，5=高度参�?�播放器高�?�宽度自�?
				pauseStretched: 2,//暂停广告拉伸方式�?0=原始大小�?1=自动缩放�?2=只有当广告的宽或高大于播放器宽高时才进行缩放�?3=参�?�播放器宽高�?4=宽度参�?�播放器宽�?�高度自动，5=高度参�?�播放器高�?�宽度自�?
				endStretched: 2 //结束广告拉伸方式�?0=原始大小�?1=自动缩放�?2=只有当广告的宽或高大于播放器宽高时才进行缩放�?3=参�?�播放器宽高�?4=宽度参�?�播放器宽�?�高度自动，5=高度参�?�播放器高�?�宽度自�?
			},
			video: { //视频的默认比例，当视频元数据里没有宽和高属�?�时默认使用该宽�?
				defaultWidth: 16,//宽度
				defaultHeight: 9 //高度
			}
		}
...
! (function() {
	...
	var ckplayer = function(obj) {
		/*
			javascript部分�?发所用的注释说明�?
			1：初始化-程序调用时即运行的代码部�?
			2：定义样�?-定义容器（div,p,canvas等）的样式表，即css
			3：监听动�?-监听元素节点（单�?-click，鼠标进�?-mouseover，鼠标离�?-mouseout，鼠标移�?-mousemove等）事件
			4：监听事�?-监听视频的状态（播放，暂停，全屏，音量调节等）事�?
			5：共用函�?-这类函数在外部也可以使用
			6：全�?变量-定义成全�?使用的变�?
			7：其它相关注�?
			全局变量说明�?
		...
		*/
		this.config = {
			videoDbClick: true,//是否支持双击全屏/�?出全屏动�?
			errorTime: 100,//延迟判断失败的时间，单位：毫�?
			videoDrawImage: false,//是否使用视频drawImage功能，注意，该功能在移动端表现不�?
			adSkipClick: 'javaScript->adjump' //h5环境中点击跳过广告按钮触发的功能
		};
		//全局变量：播放器默认配置，在外部传�?�过来相应配置后，则进行相关替换
		this.varsConfig = {
			playerID: '',//播放器ID
			container: '',//视频容器的ID
			variable: 'ckplayer',//播放函数(变量)名称
			volume: 0.8,//默认音量，范�?0-1
			poster: '',//封面图片地址
			autoplay: false,//是否自动播放
			loop: false,//是否�?要循环播�?
			live: false,//是否是直�?
			duration: 0,//指定总时�?
			forceduration:0,//强制使用该时间为总时�?
			seek: 0,//默认�?要跳转的秒数
			drag: '',//拖动时支持的前置参数
			front: '',//前一集按钮动�?
			next: '',//下一集按钮动�?
			...
			config: '',//调用配置函数名称
			type: '',//视频格式
			crossorigin: '',//设置html5视频的crossOrigin属�??
			crossdomain: '',//安全策略文件地址
			unescape: false,//默认flashplayer里需要解�?
			mobileCkControls: true,//移动端h5显示控制�?
			mobileAutoFull: true,//移动端是否默认全屏播�?
			playbackrate: 1,//默认倍�??
		...
		this.language = {
			...
			adTime: '广告{$second}�?',
			skipAd: '跳过广告',
			skipAdTime: '{$second}秒后可跳过广�?',
			adLink: '查看详情',
			noLoadShockwaveFlash:'您的浏览器不支持FlashPlayer插件或没有启用该插件',
			downLoadShockwaveFlash:'点击下载FlashPlayer插件'
		};
		//全局变量：右键菜单：[菜单标题,类型(link:链接，default:灰色，function：调用函数，javascript:调用js函数),执行内容(包含链接地址，函数名�?),[line(间隔�?)]]
		...
		//全局变量：HTML5变�?�播放的值数�?/如果不需要可以设置成null
		this.playbackRateArr = [[0.5, '0.5�?'], [1, '正常'], [1.25, '1.25�?'], [1.5, '1.5�?'], [2, '2倍�??'], [4, '4倍�??']];
		//全局变量：保存�?��??
		...
		//全局变量：设置进度按钮及进度条是否跟�?时间变化，该属�?�主要用来在按下进度按钮时暂停进度按钮移动和进度条的长度变化
		this.isTimeButtonMove = true;
		//全局变量：进度栏是否有效，如果是直播，则不需要监听时间让进度按钮和进度条变化
		this.isTimeButtonDown = false;
		//全局变量：用来模拟双击功能的判断
		this.isClick = false;
		//全局变量：计时器，用来模拟双击功能的计时�?
		this.timerClick = null;
		//全局变量：计时器，旋转loading
		this.timerLoading = null;
		//全局变量：计时器，监听鼠标在视频上移动显示控制栏
		this.timerCBar = null;
		//全局变量：播放视频时如果该变量的值大�?0，则进行跳转后设置该值为0
		this.needSeek = 0;
		//全局变量：当前音�?
		this.volume = 0;
		//全局变量：静音时保存临时音量
		this.volumeTemp = 0;
		//全局变量/变量类型：Number/功能：当前播放时�?
		this.time = 0;
		//全局变量：定义首次调�?
		this.isFirst = true;
		...
		//全局变量：预览图片加载状�?/0=没有加载�?1=正在加载�?2=加载完成
		this.previewStart = 0;
		//全局变量：预览图片容�?
		...
		//全局变量：临时存储已加载时间的变�?
		this.loadTimeTemp=0;
		//全局变量，临时存储hls形式下首次加载时是否�?要暂停或播放的判�?
	...
	ckplayer.prototype = {
		...
		*/
		analysedVideoUrl: function(video) {
			...
			if (this.typeString(video) == 'string') { //如果是字符形式的则判断后�?进行填充
			...
			else if(this.typeString(video)=='array'){//如果视频地址是数�?
				if (!this.isUndefined(typeof(video[0].length))) { //如果视频地址是二维数�?
					this.VA = video;
				}
				this.getVideo();
			}
		...
		*/
		...
		/*
			内部函数
			�?查浏览器支持的视频格式，如果是则将支持的视频格式重新分组给播放列�?
		*/
		...
		*/
		getVideo: function() {
			...
			//如果存在字幕则加�?
			if (this.V) { //如果播放器已存在，则认为是从newVideo函数发�?�过来的请求
				this.changeVideo();
				return;
			}
			...
			if (thisPd != null && isVideoH5 != null) {
				this.PD = thisPd; //PD:定义播放器容器对象全�?变量
			} else {
				...
				this.PD = this.getByElement(playerID); //PD:定义播放器容器对象全�?变量
			}
			this.css(this.CD, {
			...
			if (this.html5Video) { //如果支持HTML5-VIDEO则默认使用HTML5-VIDEO播放�?
				//禁止播放器容器上鼠标选择文本
				...
				try {
					...
					if (this.playbackRateArr && this.vars['playbackrate'] > -1) {
						...
						this.V.playbackRate = this.playbackRateArr[this.playbackRateDefault][0]; //定义倍�??
					}
				} catch(error) {}
				this.css(this.V, {
					width: '100%',
		...
		*/
		addVEvent: function() {
			...
			var eventSeeking = function(event) {
				if (document.body.clientWidth < 768) {//移动�?
                    ...
                    if (thisTemp.timeSliderLeftTemp < 1) {
                        if (thisTemp.V.currentTime > thisTemp.time && nowprocess > thisTemp.timeSliderLeftTemp) {
                          //  console.log("您点击的超出播放位置�?", nowprocess);
		...
		*/
		resetPlayer: function() {
			...
			if (this.showFace) {
				...
				this.changeLoad(0);
				this.initPlayPause(); //判断显示播放或暂停按�?
				this.definition(); //构建清晰度按�?
				this.showFrontNext(); //构建上一集下�?集按�?
				this.deletePrompt(); //删除提示�?
				this.deletePreview(); //删除预览�?
				this.trackHide(); //重置字幕
				this.resetTrack();
				this.trackElement = [];
				this.track = [];
		...
		interFace: function() {
			...
			var timeInto = this.formatTime(0) + ' / ' + this.formatTime(this.vars['duration']); //时间显示框默认显示内�?
			var randomS = this.randomString(10); //获取�?个随机字符串
			/*
				以下定义界面各元素的ID，统�?以ID结束
			*/
			var controlBarBgID = 'controlbgbar' + randomS,//控制栏背�?
			controlBarID = 'controlbar' + randomS,//控制栏容�?
			timeProgressBgID = 'timeprogressbg' + randomS,//播放进度条背�?
			loadProgressID = 'loadprogress' + randomS,//加载进度�?
			timeProgressID = 'timeprogress' + randomS,//播放进度�?
			timeBOBGID = 'timebobg' + randomS,//播放进度按钮容器，该元素为一个�?�明覆盖在播放进度条�?
			timeBOID = 'timebo' + randomS,//播放进度可拖动按钮外�?
			timeBWID = 'timebw' + randomS,//播放进度可拖动按钮内�?
			timeTextID = 'timetext' + randomS,//时间文本�?
			playID = 'play' + randomS,//播放按钮
			pauseID = 'pause' + randomS,//暂停按钮
			frontID = 'front' + randomS,//前一集按�?
			nextID = 'next' + randomS,//下一集按�?
			fullID = 'full' + randomS,//全屏按钮
			escFullID = 'escfull' + randomS,//�?出全屏按�?
			muteID = 'mute' + randomS,//静音按钮
			escMuteID = 'escmute' + randomS,//取消静音按钮				
			volumeID = 'volume' + randomS,//音量调节框容�?
			volumeDbgID = 'volumedbg' + randomS,//音量调节框容器背�?
			volumeBgID = 'volumebg' + randomS,//音量调节框背景层
			volumeUpID = 'volumeup' + randomS,//音量调节框可变宽度层
			volumeBOID = 'volumebo' + randomS,//音量调节按钮外框
			volumeBWID = 'volumebw' + randomS,//音量调节按钮内框
			definitionID = 'definition' + randomS,//清晰度容�?
			definitionPID = 'definitionp' + randomS,//清晰度列表容�?
			playbackRateID = 'playbackrate' + randomS,//倍�?�容�?
			playbackRatePID = 'playbackratep' + randomS,//倍�?�列表容�?
			subtitlesID = 'subtitles' + randomS,//多字幕容�?
			subtitlesPID = 'subtitlesp' + randomS,//多字幕列表容�?
			promptBgID = 'promptbg' + randomS,//提示框背�?
			promptID = 'prompt' + randomS,//提示�?
			dlineID = 'dline' + randomS,//分隔线共用前�?
			menuID = 'menu' + randomS,//右键容器
			pauseCenterID = 'pausecenter' + randomS,//中间暂停按钮
			loadingID = 'loading' + randomS,//缓冲
			errorTextID = 'errortext' + randomS,//错误文本�?
			logoID = 'logo' + randomS,//logo
			adBackgroundID = 'background' + randomS,//广告背景图片
			adElementID = 'adelement' + randomS,//广告容器
			adBarID = 'adBar' + randomS,//广告顶部倒计时，跳过广告，静音按钮容�?
			adSkipID = 'adskip' + randomS,//跳过广告按钮
			adTimeID = 'adtime' + randomS,//倒计时按�?
			adLinkID = 'adlink' + randomS,//广告链接按钮
			adMuteID = 'admute' + randomS,//广告静音按钮
			adEscMuteID = 'adescmute' + randomS,//广告取消静音按钮
			adPauseCloseID = 'adpauseclose' + randomS; //暂停广场的关闭按�?
			/*
				构建�?些PD（播放器容器）里使用的元�?
			*/
			...
			*/
			...
			html += '<div class="' + dlineID + '-la"></div>'; //分隔�?
			html += '<div class="' + frontID + '" data-title="' + thisTemp.language['front'] + '">' + this.newCanvas(frontID, bWidth, bHeight) + '</div>'; //前一集按�?
			html += '<div class="' + dlineID + '-lb"></div>'; //分隔�?
			html += '<div class="' + nextID + '" data-title="' + thisTemp.language['next'] + '">' + this.newCanvas(nextID, bWidth, bHeight) + '</div>'; //下一集按�?
			html += '<div class="' + dlineID + '-lc"></div>'; //分隔�?
			html += '<div class="' + timeTextID + '">' + timeInto + '</div>'; //时间文本
			html += '<div class="' + fullID + '" data-title="' + thisTemp.language['full'] + '">' + this.newCanvas(fullID, bWidth, bHeight) + '</div>'; //全屏按钮
			html += '<div class="' + escFullID + '" data-title="' + thisTemp.language['escFull'] + '">' + this.newCanvas(escFullID, bWidth, bHeight) + '</div>'; //�?出全屏按�?
			html += '<div class="' + dlineID + '-ra"></div>'; //分隔�?
			html += '<div class="' + definitionID + '" data-title="' + thisTemp.language['definition'] + '"></div>'; //清晰度容�?
			html += '<div class="' + dlineID + '-rb"></div>'; //分隔�?
			html += '<div class="' + playbackRateID + '" data-title="' + thisTemp.language['playbackRate'] + '"></div>'; //倍�??
			html += '<div class="' + dlineID + '-rc"></div>'; //分隔�?
			html += '<div class="' + subtitlesID + '" data-title="' + thisTemp.language['subtitles'] + '"></div>'; //字幕
			html += '<div class="' + dlineID + '-rd"></div>'; //分隔�?
			html += '<div class="' + volumeID + '"><div class="' + volumeDbgID + '"><div class="' + volumeBgID + '"><div class="' + volumeUpID + '"></div></div><div class="' + volumeBOID + '"><div class="' + volumeBWID + '"></div></div></div></div>'; //音量调节�?,音量调节按钮
			html += '<div class="' + muteID + '" data-title="' + thisTemp.language['mute'] + '">' + this.newCanvas(muteID, bWidth, bHeight) + '</div>'; //静音按钮
			html += '<div class="' + escMuteID + '" data-title="' + thisTemp.language['escMute'] + '">' + this.newCanvas(escMuteID, bWidth, bHeight) + '</div>'; //�?出静音按�?
			html += '<div class="' + dlineID + '-re"></div>'; //分隔�?
			...
			this.getByElement(errorTextID).innerHTML = this.language['error']; //构建错误时显示的文本�?
			//构建广告相关
			...
			var pd = this.PD;
			//CB:Object：全�?变量，将�?些全�?�?要用到的元素统一放在CB对象�?
			this.CB = {
			...
			var cLoadingFillRect = function() {
				...
				cLoading.beginPath(); //路径�?�?
				cLoading.arc(30, 30, 25, 0, 0.4 * Math.PI, false); //用于绘制圆弧context.arc(x坐标，y坐标，半径，起始角度，终止角度，顺时�?/逆时�?)
				cLoading.stroke(); //绘制
				cLoading.closePath(); //路径结束
				cLoading.beginPath(); //路径�?�?
				cLoading.strokeStyle = grad2; //设置描边样式
				cLoading.arc(30, 30, 25, 0.5 * Math.PI, 0.9 * Math.PI, false); //用于绘制圆弧context.arc(x坐标，y坐标，半径，起始角度，终止角度，顺时�?/逆时�?)
				cLoading.stroke(); //绘制
				cLoading.beginPath(); //路径�?�?
				cLoading.strokeStyle = grad3; //设置描边样式
				cLoading.arc(30, 30, 25, Math.PI, 1.4 * Math.PI, false); //用于绘制圆弧context.arc(x坐标，y坐标，半径，起始角度，终止角度，顺时�?/逆时�?)
				cLoading.stroke(); //绘制
				cLoading.beginPath(); //路径�?�?
				cLoading.strokeStyle = grad4; //设置描边样式
				cLoading.arc(30, 30, 25, 1.5 * Math.PI, 1.9 * Math.PI, false); //用于绘制圆弧context.arc(x坐标，y坐标，半径，起始角度，终止角度，顺时�?/逆时�?)
				cLoading.stroke(); //绘制
				cLoading.closePath(); //路径结束
				cLoading.restore();
			};
			...
			var cPauseCenterFillRect = function() {
				...
				cPauseCenter.beginPath(); //路径�?�?
				cPauseCenter.arc(40, 40, 35, 0, 2 * Math.PI, false); //用于绘制圆弧context.arc(x坐标，y坐标，半径，起始角度，终止角度，顺时�?/逆时�?)
			...
			this.controlBarHide(); //单独注册控制栏隐藏事�?
			...
			this.showFrontNext();
			setTimeout(function() {
				thisTemp.elementCoordinate(); //调整中间暂停按钮/loading的位�?/error的位�?
			},
			100);
			this.checkBarWidth();
			var resize = function() {
				...
				thisTemp.changeElementCoor(); //修改新加元件的坐�?
		...
		*/
		progressClick: function(obj) {
			/*
				...
				pd:
			*/
			//建立参�?�元素的mouseClick事件，用来做为鼠标在其上按下时触发的状�??
			var thisTemp = this;
		...
		*/
		slider: function(obj) {
			...
			*/
			...
			referLeft = 0;
			var value = 0;
			var calculation = function() { //根据滑块的left计算百分�?
		...
		*/
		newDefinition: function(title) {
			...
			if (this.playbackRateTemp!=1) {
				this.V.playbackRate = this.playbackRateTemp; //定义倍�??
			}
			this.timerErrorFun();
		},
		/*
				...
				if (srcArr.length > 0) {
					...
					var loadImg = function(i) {
						...
						img.onload = function(event) {
							loadNum++;
							if (thisTemp.previewDiv == null) { //如果没有建立DIV，则�?
								imgW = img.width;
								imgH = img.height;
		...
		*/
		...
		loadAdvertisements: function() {
			...
			if (this.isStrImage(type)) {
				...
				if (this.V != null && this.V.currentTime > 0 && this.adIsVideoTime) { //当有视频广告时�?�又没有记录下已播放的时间则进行记录
					this.adIsVideoTime = false;
					this.needSeek = this.V.currentTime;
				}
				this.V.src = ad['file'];
		...
		*/
		checkAdOther: function(t) {
			...
			for (var i = 0; i < adTime.length; i++) {
				if (t >= adTime[i] && !adPlay[i]) { //如果播放时间大于广告时间而该广告还没有播放，则开始播�?
					adPlay[i] = true;
					this.newAdOther(i);
				}
			}
		...
		*/
		checkAdInsert: function(t) {
			...
			for (var i = adTime.length - 1; i > -1; i--) {
				if (t >= adTime[i] && t < duration - 2 && t > 1 && !adPlay[i]) { //如果播放时间大于广告时间而该广告还没有播放，则开始播�?
					this.adI = 0;
					this.adType = 'insert';
					this.adMuteInto();
					this.adIsVideoTime = true;
		...
		*/
		...
		/*
			...
			监听播放时间改变时间显示文本�?
		*/
		timeTextHandler: function() { //显示时间/总时�?
			if (!this.showFace) {
				return;
			}
		...
		*/
		trackShowHandler: function() {
			...
			var nowTrack = this.track[this.trackIndex]; //当前编号对应的字幕内�?
			/*
				this.nowTrackShow=当前显示在界面上的内�?
				如果当前时间正好在nowTrack时间内，则需要判�?
			*/
			if (this.time >= nowTrack['startTime'] && this.time <= nowTrack['endTime']) {
				/*
				 	如果当前显示的内容不等于当前�?要显示的内容时，则需要显示正确的内容
				*/
				...
				/*
				 * 如果当前播放时间不在当前编号字幕内，则需要先清空当前的字幕内容，再显示新的字幕内�?
				 */
				this.trackHide();
				this.checkTrack();
			}
		...
		*/
		...
		/*
			内置函数
			全屏/�?出全屏动作，该动作只能是用户操作才可以触发，比如用户点击按钮触发该事�?
		*/
		switchFull: function() {
			if (this.full) {
				this.quitFullScreen();
		...
		*/
		getVarsObject: function() {
			...
			var f = '',
			d = '',
			w = ''; //f=视频地址，d=清晰度地�?,w=权重，z=�?终地�?
			var arr = this.VA;
			var prompt = v['promptSpot'];
			var i = 0;
			var video = this.vars['video'];
			if (typeof(video) == 'object') { //对象或数�?
				if (!this.isUndefined(typeof(video.length))) { //说明是数�?
					var arr = video;
					for (i = 0; i < arr.length; i++) {
						var arr2 = arr[i];
						if (arr2) {
				...
				for (i = 0; i < list.length; i++) {
					...
					case 'text':
						textObj = {
							...
							backAlpha: 1,
							backRadius: 0,
							//背景圆角弧度，支持数字统�?设置，也支持分开设置[30,20,20,50]，对应上左，上右，下右，下左
							clickEvent: ''
						};
						list[i] = this.standardization(textObj, list[i]);
						clickEvent = this.clickEvent(list[i]['clickEvent']);
		...
		*/
		...
		/*
			...
			缓动效果
			ele:Object=�?要缓动的对象,
			parameter:String=�?要改变的属�?�：x,y,width,height,alpha,
			effect:String=效果名称,
			start:Int=起始�?,
			end:Int=结束�?,
			speed:Number=运动的�?�秒数，支持小数
		*/
		animate: function(attribute) {
			...
			//先将该元件从元件数组里删除，让其不再跟随播放器的尺寸改变而改变位�?
			...
			var pm = this.getElement(obj['element']); //包含x,y,width,height,alpha属�??
			var t = 0; //当前时间
			var b = 0; //初始�?
			var c = 0; //变化�?
		...
		*/
		...
		/*
		 	共用函数
			功能：修改样式或获取指定样式的�?�，
				elem：ID对象或ID对应的字符，如果多个对象�?起设置，则可以使用数�?
				attribute：样式名称或对象，如果是对象，则省略掉value�?
				value：attribute为样式名称时，定义的样式�?
				示例�?�?
		...
		*/
		css: function(elem, attribute, value) {
			var i = 0;
			var k = '';
			if (typeof(elem) == 'object') { //对象或数�?
				if (!this.isUndefined(typeof(elem.length))) { //说明是数�?
		...
		*/
		addListener: function(name, funName) {
			if (name && funName) {
				if (this.playerType == 'flashplayer') {
					var ff = ''; //定义用来向flashplayer传�?�的函数字符
		...
		*/
		...
		/*
			...
			格式化时分秒
			seconds:Int：秒�?
			ishours:Boolean：是否显示小时，如果设置成false，则会显示如80:20，表�?1小时20分钟20�?
		*/
			...
			if (obj.dataType === 'json' || obj.dataType === 'text' || obj.dataType === 'html') {
				...
				callback = function() {
					...
					if (xhr.status == 200) {
						...
						if (obj.dataType === 'json') {
							try {
								obj.success(eval('(' + xhr.responseText + ')')); //回调传�?�参�?
							} catch(event) {
								obj.success(null);
							}
						} else {
							obj.success(xhr.responseText); //回调传�?�参�?
						}
					} else {
						obj.success(null);
				...
				if (obj.async === true) { //true表示异步，false表示同步
					xhr.onreadystatechange = function() {
						if (xhr.readyState == 4 && callback != null) { //判断对象的状态是否交互完�?
							callback(); //回调
						}
					};
				}
				...
				var params = this.formatParams(obj.data) + '&callback=' + callbackName; //按时间戳拼接字符�?
		...
		*/
		parseSrtSubtitles: function(srt) {
			...
			var delHtmlTag = function(str) {
				return str.replace(/<[^>]+>/g, ''); //去掉�?有的html标记
			};
			...
			for (i = 0; i < textSubtitles.length; ++i) {
				...
				if (textSubtitle.length >= 2) {
					var sn = textSubtitle[0]; // 字幕的序�?
					var startTime = this.toSeconds(this.trim(textSubtitle[1].split(' --> ')[0])); // 字幕的开始时�?
					var endTime = this.toSeconds(this.trim(textSubtitle[1].split(' --> ')[1])); // 字幕的结束时�?
					var content = [delHtmlTag(textSubtitle[2])]; // 字幕的内�?
		...
		*/
		timer: function(time, fun, number) {
			...
			this.number = 0; //已运行次�?
			this.numberTotal = null; //总至�?要次�?
			this.runing = false; //当前状�??
