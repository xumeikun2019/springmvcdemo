...
<div class="container">
		<fieldset class="layui-elem-field layui-field-title"
			...
			<legend>上下班时间修改</legend>
		</fieldset>
		<form id="form" class="layui-form layui-form-pane" action="">
                <div class="layui-form-item">
		               <label class="layui-form-label">公司名称</label>
		               <div class="layui-input-block">
 							<input id="fgsId" name="fgsId" type="text" autocomplete="off" class="layui-input" lay-filter="dq" value="${pojo.fgsId}" disabled="disabled"></input>		               
 						</div>
           		</div>
           		<div class="layui-form-item">
		               	<label class="layui-form-label">班次</label>
		              	<div class="layui-input-block">
                   			<input type="text" id="cname" name="cname" class="layui-input" value="${pojo.cname}">
               			</div>
          		</div>
           		<div class="layui-form-item">
		               	<label class="layui-form-label">上班时间</label>
		              	<div class="layui-input-block">
                   			<input type="text" id="timeStart" name="timeStart" class="layui-input" value="${pojo.timeStart}">
               			</div>
          		</div>
          		<div class="layui-form-item">
		               	<label class="layui-form-label">下班时间</label>
		              	<div class="layui-input-block">
                   			<input type="text" id="timeEnd" name="timeEnd" class="layui-input" value="${pojo.timeEnd}">
               			</div>
          		</div>
          		<div class="layui-form-item">
		               	<label class="layui-form-label">备注</label>
		              	<div class="layui-input-block">
                   			<input type="text" id="remark" name="remark" class="layui-input" value="${pojo.remark}">
               			</div>
          		</div> 
                 <div class="layui-form-item">
