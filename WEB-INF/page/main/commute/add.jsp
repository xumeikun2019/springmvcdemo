...
<div class="container">
		<fieldset class="layui-elem-field layui-field-title"
			...
			<legend>上下班时间添加</legend>
		</fieldset>
		<form id="form" class="layui-form layui-form-pane" action="">
                <div class="layui-form-item">
		               <label class="layui-form-label">公司名称</label>
		               <div class="layui-input-block">
 							<input id="fgsName" name="fgsName" type="text" autocomplete="off" class="layui-input" lay-filter="dq" value="${parentName}" disabled="disabled"></input>		               
 						</div>
           		</div>
           		<div class="layui-form-item">
           		...
           		<div class="layui-form-item">
		              	...
		              	<div class="layui-input-block">
                   			<input type="text" id="timeStart" name="timeStart" class="layui-input">
               			</div>
          		</div>
          		<div class="layui-form-item">
		               	<label class="layui-form-label">下班时间</label>
		              	<div class="layui-input-block">
                   			<input type="text" id="timeEnd" name="timeEnd" class="layui-input">
               			</div>
          		</div>
          		<div class="layui-form-item">
